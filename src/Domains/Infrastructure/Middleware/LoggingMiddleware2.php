...
class LoggingMiddleware2 implements MiddlewareInterface
{
    ...
    public function __construct(?string $logFile = null)
    {
        ...
        $this->logFile = $logFile ?? dirname(__DIR__, 4) . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'requests2.log';
