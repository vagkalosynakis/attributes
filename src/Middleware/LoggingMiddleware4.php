...
class LoggingMiddleware4 implements MiddlewareInterface
{
    ...
    public function __construct(?string $logFile = null)
    {
        ...
        $this->logFile = $logFile ?? dirname(__DIR__, 2) . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'requests4.log';
